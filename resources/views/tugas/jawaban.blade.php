        ...
        <!-- general form elements -->
                <div class="card card-primary">
                    <div class="card-header">
                        <strong class="card-title">Tugas milik {{$jawaban->user->mahasiswa->nama}}</strong>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <embed src="{{ asset('file_jawaban/' . $jawaban->jawaban)}}" type="application/pdf" width="1000" height="700" >
                                            {{-- <img src="{{ asset('file_jawaban/' . $jawaban->jawaban)}}"> --}}
                                        @endif
                                    </div>
                                    <a href="/tugas/{{$jawaban->tugas->id}}/detail" class="btn btn-secondary">Kembali</a>
                                </div>
                            </div>
                    </div>
                </div>
