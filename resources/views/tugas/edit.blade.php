    ...
    <div class="container-fluid">
        ...
        <!-- general form elements -->
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <form method="post" action="/tugas/{{$tugas->id}}/update"  enctype="multipart/form-data">
                        {{-- token keamanan --}}
                        @method('patch')
                        @csrf 
                            ...
                            <div class="form-group">
                                <label for="matkul">Mata kuliah</label>
                                    <select class="form-control @error('txtmatkul') is-invalid @enderror" value="" name="txtmatkul" id="exampleFormControlSelect1">
                                        @foreach($dosen->matkul as $mtkuliah)
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('txtjudul', $tugas->judul_tugas)}}" class="form-control @error('txtjudul') is-invalid @enderror" name="txtjudul" id="judul" placeholder="Masukkan judul">
                                @error('txtjudul ')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="form-group">
                                <label for="soal">Soal</label><br>
                                    <textarea rows="3" class="form-control @error('txtsoal') is-invalid @enderror" name="txtsoal" style="white-space: pre-line;">{{$tugas->soal_tugas}}</textarea>
                                        @error('txtsoal')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
