                        ...
                        <form method="post" action="/tambahadmin">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 @error('txtusername') is-invalid @enderror">
                                    <input id="passlama" value="{{old('txtusername')}}" type="text" name="txtusername" class="form-control @error('txtusername') is-invalid @enderror">
                                    @error('txtusername')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="passbaru" type="text" name="txtnama" class="form-control @error('txtnama') is-invalid @enderror">
                                    @error('txtnama')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="passbaru" type="text" name="txtemail" class="form-control @error('txtemail') is-invalid @enderror">
                                    @error('txtemail')
                                            <span class="invalid-feedback">
                                                {{$message}}
                                            </span>
